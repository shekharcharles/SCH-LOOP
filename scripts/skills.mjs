...
export const SCH_COMMANDS = [
  ...
  { name: "run", status: "implemented", routes_to: "skill:sch-run", summary: "run one pass of the in-session loop", note: "the EXTERNAL autonomous runner (fresh Claude worker processes) is not implemented", milestone: "supervised external single-task runner" },
