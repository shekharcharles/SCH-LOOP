...
export const SCH_COMMANDS = [
  ...
  { name: "run", status: "implemented", routes_to: "skill:sch-run", summary: "run one pass of the in-session loop", note: "for ONE task in a fresh EXTERNAL claude process use sch-run-task.mjs; automatic retry, queue continuation and any target-project commit/push are not implemented", milestone: "target-project Git transaction controller" },
